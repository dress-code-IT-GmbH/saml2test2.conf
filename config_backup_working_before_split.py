...
class Config(ExampleConfig):
    ...
    def config(self):
        ...
        self.PORT = 8087
        self.METADATA = [
            {'metadata': [('http://mdfeed.samltest.fed-lab.org/split/testidp01SamltestFed-labOrg_idpShibboleth.xml',)],
        ...
        self.CONTENT_HANDLER_INTERACTION = [
            ...
            { # sometimes the IDP shows a page to ask for consent, which needs to be filled out.
                "matches": {
                    "url": "%s/idp/profile/SAML2/Redirect/SSO" % self.IDP_BASE,
